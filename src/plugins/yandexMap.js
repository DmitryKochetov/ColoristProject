(function ymapsInit(e) {
  ...
  (t.performance = {
      ...
      (function (e) {
        ...
        return (
          (function (e) {
            var n,
              o = (function () {
                ...
                if (o) {
                  ...
                  return (
                    new o(r).observe(s, { characterData: !0 }),
                    function (e) {
                      t(e) && (s.data = i *= -1);
                    }
                  );
            ...
            m.prototype = {
              ...
              _resolve: function (e) {
                if (!(this._status > h.RESOLVED)) {
                  ...
                  if (((this._status = h.RESOLVED), e && e._vow))
                    return void (e.isFulfilled()
                      ? this._fulfill(e.valueOf())
                      : e.isRejected()
                      ? this._reject(e.valueOf())
                      : e.then(
                          this._fulfill,
                          this._reject,
                          this._notify,
              ...
              _addCallbacks: function (e, t, r, o, i) {
                ...
                var a;
                this.isRejected() ||
                  ((a = { defer: e, fn: s(t) ? t : n, ctx: i }),
                  this.isFulfilled()
                    ? this._callCallbacks([a], this._value)
                    : this._fulfilledCallbacks.push(a)),
                  this.isFulfilled() ||
                    ((a = { defer: e, fn: r, ctx: i }),
                    this.isRejected()
                      ? this._callCallbacks([a], this._value)
            ...
            for (var g in y) y.hasOwnProperty(g) && (m[g] = y[g]);
            var _ = {
              Deferred: v,
              Promise: m,
              defer: function () {
                ...
                return _.allResolved(e).then(function () {
                  ...
                  for (; u < a; )
                    (r = s[u++]),
                      ...
                      _.isRejected(o)
                        ? (n || (n = i ? [] : {}),
                          i ? n.push(o.valueOf()) : (n[r] = o.valueOf()))
              ...
              anyResolved: function (e) {
                var n = new v(),
                  t = e.length;
                return t
                  ? (_._forEach(e, n.resolve, n.reject, n.notify, n),
                    n.promise())
                  : (n.reject(Error()), n.promise());
              },
              delay: function (e, n) {
    ...
    (t.utils = (function (e) {
      ...
      return (
        (r.nextTick = o.__nextTick__),
        (o.__nextTick__ = void 0),
        ...
        (r.extend = Object.assign
          ...
          : function (e) {
              for (var n = 1, t = arguments.length; n < t; n++) {
                var r = arguments[n];
                if (null != r) for (var o in r) i.call(r, o) && (e[o] = r[o]);
              }
              return e;
            }),
        ...
        (r.registerImports = function (e, n, t) {
          for (var o = 0; o < n.length; o++)
            if (t[o].__expand)
              r.registerImports(
                e,
                t[o].__expand.depends,
                t[o].__expand.imports
              );
            else {
  ...
  r &&
    r.parent &&
    r.parent[r.name] &&
    r.parent[r.name].modules &&
    r.parent[r.name].ready &&
    console.error(
    ...
    (t.supports.csp = {
      ...
      isNonceSupported:
        t.env.browser.name && t.env.browser.version
          ? !(
    ...
    (function () {
      function e() {
        ...
        var e = { "Samsung Internet": !0, AndroidBrowser: !0 },
          n =
            "Webkit" == t.env.browser.engine &&
            +t.env.browser.engineVersion < 537;
      ...
      function n() {
        ...
        try {
          ...
          (t = r.getContext((n = "webgl"), o)),
            t ||
              ((t = r.getContext((n = "experimental-webgl"), o)),
              t || (n = null));
        } catch (i) {
          n = null;
        }
    ...
    (function () {
      function e() {
        ...
        "MacOS" == t.env.browser.osFamily &&
          /^10\.[0-8](\.|$)/.test(t.env.browser.osVersion) &&
          ((e = !1), n("OldMac"));
        var i = [
        ...
        0 == a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS) &&
          ...
          a.getExtension("OES_vertex_array_object") ||
            ((e = !1), n("OES_vertex_array_object")),
          a.getExtension("OES_standard_derivatives") ||
            ((e = !1), n("OES_standard_derivatives"));
      ...
      function r() {
        ...
        return (
          n.readPixels(0, 0, 1, 1, n.RGBA, n.UNSIGNED_BYTE, s), 255 === s[0]
        );
      }
      function o() {
        var e = {},
        ...
        return (
          o &&
            ((e.vendor = r
              .getParameter(o.UNMASKED_VENDOR_WEBGL)
              .replace(/\W/g, "_")),
            (e.renderer = r
    ...
    (t.supports.printPatchNeeded =
      !t.supports.css.checkProperty("printColorAdjust")),
    (t.logger = (function (e) {
      function n(e, n) {
        var r = "";
    ...
    (function () {
      var e = t.env.browser;
      (e.documentMode = document.documentMode),
        (e.isIE = "MSIE" == e.name || "IEMobile" == e.name),
        (e.isEdge = "Edge" == e.engine),
        (e.isChromium = e.base && "chromium" == e.base.toLocaleLowerCase()),
        (e.isSafari = "Safari" == e.name);
      var n =
        "Edge" == e.engine ||
        ("MSIE" == e.name && e.osVersion > 6.1) ||
        ("IEMobile" == e.name && e.engineVersion >= 6);
      n ? (e.eventMapper = "pointer") : (e.eventMapper = "touchMouse"),
        (e.androidBrokenBuild =
          "AndroidBrowser" == e.name && "534.30" == e.engineVersion);
      var r =
        ...
        o =
          "iOS" === e.osFamily ||
          "Safari" === e.name ||
          ("WebKit" === e.engine && "Safari" === e.base);
      "MSIE" == e.name ||
      "IEMobile" == e.name ||
      ("Android" == e.osFamily && "Gecko" == e.engine) ||
      o ||
      (r > 1 && r < 2)
        ? (e.graphicsRenderEngine = "svg")
        : (e.graphicsRenderEngine = "canvas"),
        (e.transformTransition =
          "Android" == e.osFamily ||
          "iOS" == e.osFamily ||
          "MSIE" == e.name ||
          e.isChromium),
        (e.css3DTransform =
          ("WebKit" == e.engine &&
            !("Android" == e.osFamily && parseFloat(e.osVersion) < 3)) ||
          ("Gecko" == e.engine &&
            parseInt(e.engineVersion.split(".")[0]) >= 10)),
        (e.unsupported = "OperaMini" == e.name);
    })();
  var o = (function (e) {
      function n(n) {
        return e[n];
      ...
      function t(e) {
        (this._config = e),
          ...
          (this._definitionsByStorage = Object.create(null)),
          (this._remoteLoadingAllowed = f.defer()),
      ...
      function r(e, n, t, r, o, i, s, a, u) {
        (this.state = e),
          ...
          (this.key = r),
          (this.depends = o),
          (this.dynamicDepends = a),
          (this.declaration = i),
          (this.context = s),
          (this.exports = e === m.DEFINED ? u : void 0),
          (this.resolvingPromise = void 0),
          (this.fetchingDeferred = void 0);
      }
      function o(e, n) {
      ...
      function a(e) {
        return e && "object" == typeof e ? e.key + "@" + e.storage : String(e);
      }
      function u(e) {
        return (
          null != e &&
      ...
      return (
        (l.exports = t),
        (t.prototype.allowRemoteLoading = function () {
        ...
        (t.prototype._define = function (e) {
          ...
          if (t) {
            ...
            return (
              t.state !== m.FETCHING && n(),
              (t.state = m.DECLARED),
              (t.declaration = e.declaration),
              (t.context = e.context),
              (t.storage = e.storage),
              (t.key = e.key),
              e.depends &&
                ("function" == typeof e.depends &&
                  (e.depends = e.depends.call(
                    { name: e.name },
                    this._config.dependenciesContext
                  )),
                (t.depends = e.depends)),
              (t.dynamicDepends = e.dynamicDepends),
              void (t.exports = e.exports)
            );
          }
          "function" == typeof e.depends &&
            (e.depends = e.depends.call(
            ...
            (e.depends = e.depends || h),
            (this._definitionsByName[e.name] = e),
            this._saveDefinitionToStorage(e);
        }),
        (t.prototype._resolve = function (e, n) {
          ...
          e.state < m.RESOLVING &&
            !e.resolvingPromise &&
            (e.resolvingPromise = this._resolveCore(e, n).always(function (n) {
              return (e.resolvingPromise = void 0), n;
            }));
          var t = o(e, [n]);
          return f
            .all([e.resolvingPromise, this._require(t, n)])
            .then(function () {
        ...
        (t.prototype._resolveCore = function (e, n) {
          return this._fetchModule(e, n)
            ...
            .then(function (n) {
              function t(n, t) {
                e.state === m.RESOLVING &&
                  ((e.state = t ? m.ERROR : m.DEFINED), (e.exports = t || n)),
                  o && o.resolve(),
                  t &&
                    console.warn(
              ...
              return r
                ? r
                : e.state !== m.DEFINED && e.state !== m.ERROR
                ? (console.warn(
          ...
          return t
            ...
            : this._initialized.then(function () {
                ...
                return t
                  ...
                  : f.reject(
                      new Error(
                        "ymaps.modules: module `" + a(e) + "` is not defined."
                      )
                    );
              }, this);
        }),
        ...
        (t.prototype._saveDefinitionToStorage = function (e, n) {
          if (e.key && e.storage) {
            ...
            for (
              var t = d.isArray(n.key) ? n.key : [n.key], r = 0, o = t.length;
              r < o;
              r++
            )
              (this._definitionsByStorage[n.storage] =
                this._definitionsByStorage[n.storage] || {}),
        ...
        (t.prototype._loadFullBundle = function () {
          if (!this._fullBundlePromise) {
            for (var e in this._definitionsByName)
              this._definitionsByName[e].state === m.MENTIONED &&
                (this._definitionsByName[e].state = m.FETCHING);
    ...
    i =
      t.env.server.url +
      "/" +
      t.env.server.path.replace(/\/$/, "") +
      "/images/";
  (t.modules = new o({
    dependenciesContext: t,
    initialBudleName: t.env.preload.bundle,
    fetchBundle: function (e) {
      var r = ("__ymaps_" + t.env.namespace + "_" + Date.now()).replace(
        /\W/g,
        "_"
      );
      n[r] = t.ns;
      var o = document.createElement("script");
      (o.src = t.env.hosts["static"] + t.env.bundles[e]),
        o.setAttribute("data-ymaps-api-ns", r),
        o.setAttribute("data-ymaps-api-version", "2.1.79-13114254"),
        (o.async = !0);
      var i = t.vow.defer();
      return (
        (o.onerror = i.reject.bind(i)),
        (t.ns.__provideBundle = i.resolve.bind(i)),
        document.head.appendChild(o),
        i.promise().always(function (e) {
          return delete n[r], e;
        })
      );
    },
    createSandbox: function (e) {
      ...
      var r = t.utils.extend({}, t, { modules: n }),
        o = {};
      return (
        Object.defineProperty(r, "__mock__", {
          get: function () {
    ...
    (t.ns.load = function (e, n, r, o) {
      return "function" == typeof e
        ? n
          ...
          : t.ns.ready(["package.full"], e)
        : ("string" == typeof e && (e = [e]),
          t.ns.ready.apply(this, arguments));
    }),
    (function () {
      function e(e) {
        return function () {
    ...
    (function (e) {
            ...
            ? "function" != typeof arguments[0]
              ? ((e.require =
                  "string" == typeof arguments[0]
                    ? [arguments[0]]
                    : arguments[0]),
                (e.successCallback = arguments[1]),
                (e.errorCallback =
                  arguments[2] && "function" == typeof arguments[2]
                    ? arguments[2]
                    : null),
                (e.context =
                  arguments[2] && "object" == typeof arguments[2]
                    ? arguments[2]
                    : arguments[3]))
              : ((e.successCallback = arguments[0]),
                (e.errorCallback =
                  arguments[1] && "function" == typeof arguments[1]
                    ? arguments[1]
                    : null),
                (e.context =
                  arguments[1] && "object" == typeof arguments[1]
                    ? arguments[1]
                    : arguments[2]))
            : (e = arguments[0]));
        var n = e.require || [],
      ...
      var i = t.vow,
        s = [].concat(
          ["package.system"],
          t.env.preload.load.split(",").filter(Boolean)
        ),
        a = t.modules.require(s).then(
          function (e) {
          ...
          "interactive" === document.readyState
            ...
            : new i.Promise(function (e) {
                document.addEventListener("DOMContentLoaded", e, !1),
                  document.addEventListener("load", e, !1);
              });
      t.ns.ready = n;
      var c = !0;
    })(this),
    t.env.server.params.csp &&
      !t.supports.csp.isSupported &&
      t.logger.warning("CSP is not supported in this browser"),
    t.modules.define(
      ...
      function (e, n) {
        function r() {
          ...
          return (
            (r.onload = e.resolve.bind(e)),
            (r.onerror = e.reject.bind(e)),
            (r.src = t.env.hosts.vectorIndex.replace(
              "{{version}}",
              t.env.vector.version
            )),
            t.env.vector.filename &&
              (r.src = r.src.replace("vector.min.js", t.env.vector.filename)),
        ...
        if (null == t.env.vector.version) throw new Error("No vector version.");
        var o = null;
        e(function () {
          return (o = o || r());
        });
    ...
    t.modules.define("vectorEngine.preload", [], function (e) {
      t.supports.vector.isSupported() &&
        t.modules.require(["vectorEngine.loadEngine"]).spread(function (e) {
          e();
        }),
        e({});
    }),
    t.modules.allowRemoteLoading(),
    r && (r.parent[r.name] = t.ns),
    t.env.apikeyValid || console.warn("(Yandex Maps JS API): Invalid API key");
})({
  mode: "release",
  debug: false,
  namespace: "ymaps",
  ...
  enterprise: false,
  bundles: {
    full: "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-13114254/build/release/full-2383587e566073d105d35dad05bb01d1698b04bf.js",
  },
  version: "2.1.79",
  tag: "2.1.79-13114254",
  ...
  server: {
    ...
    path: "build/release",
    params: { apikey: "6a1b09a0-dfe3-473d-b3dc-de781a109967", csp: null },
    version: "2.1",
  },
  preload: { load: "package.full", bundle: "full" },
  token: "8f1743a56be18ff70748b9e3f3750243",
  taxiInceptionBboxes: [
    [
  ...
  allowDeprecatedSuggest: false,
  vector: { version: "5.21.0", ts: 1705059048878 },
  hosts: {
    api: {
    ...
    vectorMeshes:
      "https://core-renderer-tiles.maps.yandex.net/vmap2/meshes?id={{id}}",
    vectorGlyphs:
    ...
    taxiRouteInfo:
      "https://taxi-routeinfo.taxi.yandex.net/taxi_info?clid=yamaps&apikey=WlLCOrBcRkvgvXHWKlKzRPFPOGoDuhxeTUqIslT&rll={rll}",
  },
  layers: {
    map: {
      version: "24.01.12-0-b240108222000",
      scaled: true,
    ...
    sat: { version: "3.1139.0" },
    stv: { version: "2024.01.11.18.17-1_24.01.11-0-18004" },
    sta: { version: "2024.01.11.18.17-1_24.01.11-0-18004" },
    trf: { version: "1705059000", scaled: true },
  ...
  geolocation: {
    ...
    span: { longitude: 1.33442, latitude: 0.611098 },
  },
});
